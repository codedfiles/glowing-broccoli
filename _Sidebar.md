...
11. [Darknode Registry (Coming Soon)](https://github.com/renproject/ren/wiki/Darknode-Registry)
12. [Darknode Payments (Coming Soon)](https://github.com/renproject/ren/wiki/Darknode-Payments)
13. [Darknode Slasher (Coming Soon)](https://github.com/renproject/ren/wiki/Darknode-Slasher)

## API

1. [Types (Coming Soon)](https://github.com/renproject/ren/wiki/Types)
2. [Contracts (Coming Soon)](https://github.com/renproject/ren/wiki/Contracts)
3. [Transactions (Coming Soon)](https://github.com/renproject/ren/wiki/Transactions)
